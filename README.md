...
### [trash-cli](https://github.com/andreafrancia/trash-cli) <a name="trash-cli"/>
...
## deviations from the _-Standard-_ <a name="deviations"/>

### bind mounts <a name="bind"/>
...
### trash can creation <a name="creation"/>
...
### directory size cache <a name="cache"/>
...
### trashinfo `Path` key <a name="Path"/>
...
### arguments terminated by '`/`' <a name="terminated"/>
...
## extra's : spacefm plugins for batrash <a name="spacefm"/>
